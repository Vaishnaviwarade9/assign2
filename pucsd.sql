CREATE TABLE studentData(Name varchar(20), Roll_No integer, Address varchar(32), Mobile_Number bigint NOT NULL, PAN_Number varchar(10));
...
INSERT INTO studentData values('zamli', 19111025, 'heart, Ratnagiri', 7972958603, 'PQRT191111');
